...
export function SentimentBanner({ sentiment }: { sentiment: SentimentSnapshot }) {
    ...
    <section className="border border-zinc-800 bg-zinc-950/60 px-6 py-5 sm:px-8 sm:py-6">
      <div className="flex flex-wrap items-baseline justify-between gap-4">
        <div>
          ...
          <p className="mt-1 font-mono text-xs text-zinc-500">{dateLabel}</p>
        </div>
        <div className="flex items-end gap-3">
          <div className="text-right">
            <p className="font-mono text-[10px] tracking-[0.25em] text-zinc-500 uppercase">Fashion Sentiment</p>
